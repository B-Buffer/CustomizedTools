...
public final class PropertiesUtils {
	...
	public static class InvalidPropertyException extends RuntimeException {
		...
		public InvalidPropertyException(BundleUtil.Event event, String propertyName, Object value, Class<?> expectedType, Throwable cause) {
			super(CorePlugin.Util.getString("InvalidPropertyException.message", propertyName, value, expectedType.getSimpleName())); //$NON-NLS-1$
		}		
    ...
    public static int getIntProperty(Properties props, String propName, int defaultValue) throws InvalidPropertyException {
        ...
        try {
            return Integer.parseInt(stringVal);
              ...
              throw new InvalidPropertyException(CorePlugin.Event.CSTCORE1000, propName, stringVal, Integer.class, e);
        }
    }
    ...
    public static long getLongProperty(Properties props, String propName, long defaultValue) {
        ...
        try {
            return Long.parseLong(stringVal);
        	  ...
        	  throw new InvalidPropertyException( CorePlugin.Event.CSTCORE1001, propName, stringVal, Long.class, e);
        }
    }
    ...
    public static float getFloatProperty(Properties props, String propName, float defaultValue) {
        ...
        try {
            return Float.parseFloat(stringVal);
        	  ...
        	  throw new InvalidPropertyException(CorePlugin.Event.CSTCORE1002, propName, stringVal, Float.class, e);
        }
    }
    ...
    public static double getDoubleProperty(Properties props, String propName, double defaultValue) {
        ...
        try {
            return Double.parseDouble(stringVal);
        	  ...
        	  throw new InvalidPropertyException(CorePlugin.Event.CSTCORE1003, propName, stringVal, Double.class, e);
        }
    }
    ...
    public static boolean getBooleanProperty(Properties props, String propName, boolean defaultValue) {
        ...
        try {
            return Boolean.valueOf(stringVal);
        	  ...
        	  throw new InvalidPropertyException(CorePlugin.Event.CSTCORE1004, propName, stringVal, Float.class, e);
        }
    }
            ...
            while(matched) {
                ...
                if (matched) {
                    ...
                    if (key.equals(nestedkey)) {
                        ...
                        if (nestedvalue == null) {
                        	  throw new RuntimeException(CorePlugin.Util.gs(CorePlugin.Event.CSTCORE1005, nestedkey));
                        }                    
	...
	private static Class<?> setProperty(Object bean, Object value,
		...
		try {
		    ...
		    method.invoke(bean, params);
			  ...
			  throw new InvalidPropertyException(CorePlugin.Event.CSTCORE1006, propertyName, value, argType, e);
		}
		return argType;
	}    
